...
export const EngineeringTeam: React.FC = () => {
  const roles = [
    ...
    },
    {
      ...
      icon: <Database className="w-5 h-5 text-[#FF5A1F]" />,
  ...
  return (
    <section className="px-4 sm:px-6 max-w-6xl mx-auto">
      <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-10 border border-[#EDE9E4] shadow-soft text-left space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
          {roles.map((r, idx) => (
            <motion.div
              ...
              className="bg-[#FAF8F6] p-6 rounded-2xl border border-[#EDE9E4] hover:border-[#FF5A1F]/40 transition-all flex flex-col justify-between space-y-4 group"
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-extrabold text-[#FF5A1F] uppercase tracking-wider">
                    {r.role}
                  </span>
                </div>

                <div>
                  <h3 className="text-base font-extrabold text-[#111111] group-hover:text-[#FF5A1F] transition-colors">
                    {r.title}
                  </h3>
              ...
              <div className="pt-3 border-t border-[#EDE9E4]/60 space-y-2">
        ...
        <p className="text-[11px] text-[#8C867F] italic text-center">
