...
export const TermsPage: React.FC<TermsPageProps> = ({
  ...
  return (
    <motion.div
      ...
      animate="animate"
      exit="exit"
      className="space-y-10 sm:space-y-14 pb-16 sm:pb-24 overflow-x-hidden bg-[#F6F5FC]"
    >
      {/* 1. HERO SECTION */}
      <section className="pt-8 sm:pt-14 pb-4 sm:pb-8 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4 sm:space-y-5 relative z-10">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#EDEAFB] border border-[#7B5CE8]/30 text-[#5B4FE0] text-[11px] sm:text-xs font-bold uppercase tracking-wider shadow-2xs"
          >
          ...
          >
            Terms &amp; <span className="text-[#3B4FD9]">Conditions</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-sm sm:text-base text-[#5B5876] max-w-2xl mx-auto leading-relaxed"
          >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-white border border-[#EDEAFB] text-xs font-semibold text-[#151235] shadow-2xs"
          >
            <span>Last Updated:</span>
            <span className="text-[#3B4FD9] font-bold">August 30, 2026</span>
          </motion.div>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <aside className="hidden lg:block lg:col-span-4 sticky top-24 space-y-4">
            <div className="bg-white rounded-2xl p-5 border border-[#EDEAFB] shadow-soft space-y-3 text-left">
              <h3 className="text-xs font-extrabold uppercase tracking-wider text-[#151235]">
                Table of Contents
              </h3>
              <nav className="space-y-1 text-xs">
                {sections.map((item) => (
                  <a
                    key={item.id}
                    href={`#${item.id}`}
                    className="block py-1.5 px-2.5 rounded-lg text-[#5B5876] hover:text-[#3B4FD9] hover:bg-[#F6F5FC] transition-all truncate font-medium"
                  >
                    {item.title}
                  </a>
                ))}
            ...
            <div className="relative bg-gradient-to-br from-[#0A0E2A] via-[#141B5C] to-[#2A3FA8] text-white rounded-2xl p-5 border border-[#3B4FD9]/30 shadow-soft space-y-3 overflow-hidden text-left">
              ...
              <div className="relative z-10 space-y-3">
                <div className="flex items-center gap-2 text-[#7DE8FF]">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-xs font-bold text-[#7DE8FF] hover:underline"
                >
          ...
          {/* Main Legal Content */}
          <div className="lg:col-span-8 space-y-8 text-[#151235]">
            {/* 1. Acceptance */}
            <article
              id="acceptance"
              className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-[#EDEAFB] shadow-soft space-y-3 text-left"
            >
              <div className="flex items-center gap-2 text-xs font-extrabold text-[#3B4FD9] uppercase tracking-wider">
            ...
            <article
              ...
              className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-[#EDEAFB] shadow-soft space-y-4 text-left"
            >
              <div className="flex items-center gap-2 text-xs font-extrabold text-[#3B4FD9] uppercase tracking-wider">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-1">
                  <span className="font-extrabold text-[#151235] block">Custom Web Development</span>
                  <span className="text-[#5B5876]">High-performance React/TypeScript web apps, SaaS platforms, portals, and responsive websites.</span>
                </div>
                <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-1">
                  <span className="font-extrabold text-[#151235] block">Mobile App Engineering</span>
                  <span className="text-[#5B5876]">Native and cross-platform mobile apps for iOS and Android with offline sync and cloud APIs.</span>
                </div>
                <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-1">
                  <span className="font-extrabold text-[#151235] block">AI &amp; Automation Systems</span>
                  <span className="text-[#5B5876]">Enterprise RAG pipelines, fine-tuned LLMs, predictive models, and autonomous workflow bots.</span>
                </div>
                <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-1">
                  <span className="font-extrabold text-[#151235] block">Social Media &amp; Growth Retainers</span>
                  <span className="text-[#5B5876]">Creative asset production, brand presence, website management, and ongoing monthly retainer support.</span>
                </div>
              </div>
            </article>
            ...
            >
              ...
              <ol className="space-y-2 text-xs sm:text-sm text-[#5B5876] list-decimal list-inside leading-relaxed">
            ...
            >
              ...
              <ul className="space-y-1.5 text-xs text-[#5B5876] list-disc list-inside">
            ...
            >
              ...
              <div className="space-y-2 text-xs text-[#5B5876]">
            ...
            >
              ...
              <ul className="space-y-2 text-xs text-[#5B5876] list-disc list-inside">
            ...
            >
              ...
              <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-2 text-xs text-[#5B5876]">
                <p><strong className="text-[#151235]">100% Client Code Ownership:</strong> Upon receipt of full and final payment for the project or milestone, all bespoke source code, application assets, designs, databases schemas, and documentation created specifically for the Client transfer fully and unconditionally to the Client.</p>
                <p><strong className="text-[#151235]">Pre-Existing Frameworks &amp; Open Source:</strong> Open-source libraries (e.g. React, Tailwind CSS, Linux) and generic developer utility scaffolds remain subject to their respective open-source licenses (MIT, Apache 2.0).</p>
                <p><strong className="text-[#151235]">Portfolio Showcase Rights:</strong> We reserve the customary right to showcase completed project designs, non-confidential screenshots, and case summaries in our professional portfolio and website, unless the Client has executed a strict NDA requesting complete anonymity.</p>
              </div>
            </article>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1 text-xs">
                <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-1">
                  <span className="font-extrabold text-[#151235] block">Legal &amp; Business Inquiries</span>
                  <a href="mailto:info@alphaaiservices.in" className="text-[#3B4FD9] font-bold hover:underline">
                    info@alphaaiservices.in
                  </a>
                </div>
                <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-1">
                  <span className="font-extrabold text-[#151235] block">WhatsApp Channel</span>
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-[#EDEAFB]/50 border border-[#7B5CE8]/30 text-left space-y-1.5 shadow-2xs">
              <div className="flex items-center gap-2 text-[#5B4FE0]">
                <AlertCircle className="w-4 h-4 shrink-0" />
                <span className="text-xs font-extrabold uppercase tracking-wider">Legal Advisory Disclaimer</span>
              </div>
              <p className="text-[11.5px] text-[#5B5876] leading-relaxed">
