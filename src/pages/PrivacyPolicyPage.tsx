    ...
    >
      ...
      <section className="pt-8 sm:pt-14 pb-4 sm:pb-8 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4 sm:space-y-5 relative z-10">
          ...
          >
            Privacy <span className="text-[#3B4FD9]">Policy</span>
          </motion.h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-8 text-[#151235]">
            ...
            >
              ...
              <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] text-xs text-[#5B5876] leading-relaxed">
                <strong className="text-[#151235]">Statutory Compliance Intent:</strong> We design our data management workflows with the intent to adhere to applicable Indian legislation, notably the <em>Digital Personal Data Protection Act (DPDP Act), 2023</em> and the <em>Information Technology Act, 2000</em> (alongside associated Information Technology Reasonable Security Practices and Procedures Rules).
              </div>
            </article>
            ...
            >
              ...
              <div className="space-y-3">
                <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-1">
                  <h4 className="text-xs font-extrabold text-[#151235]">A. Contact & Consultation Information</h4>
                ...
                <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-1">
                  <h4 className="text-xs font-extrabold text-[#151235]">B. Technical & Analytics Information</h4>
                  <p className="text-xs text-[#5B5876] leading-relaxed">
                ...
                <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-1">
                  <h4 className="text-xs font-extrabold text-[#151235]">C. Communication Records</h4>
                  <p className="text-xs text-[#5B5876] leading-relaxed">
            ...
            >
              ...
              <ul className="space-y-2 text-xs sm:text-sm text-[#5B5876] list-disc list-inside leading-relaxed">
            ...
            >
              ...
              <p className="text-xs text-[#5B5876] italic">
            ...
            >
              ...
              <div className="p-3.5 rounded-xl bg-[#EDEAFB] border border-[#7B5CE8]/20 text-xs font-bold text-[#5B4FE0]">
            ...
            >
              ...
              <p className="text-xs text-[#5B5876] pt-1">
                To exercise any of these rights, email us at <a href="mailto:info@alphaaiservices.in" className="text-[#3B4FD9] font-bold hover:underline">info@alphaaiservices.in</a>. We respond to verified data requests within statutory time limits.
              </p>
            </article>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1 text-xs">
                <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-1">
                  <span className="font-extrabold text-[#151235] block">Official Email</span>
                  <a href="mailto:info@alphaaiservices.in" className="text-[#3B4FD9] font-bold hover:underline">
                    info@alphaaiservices.in
                  </a>
                </div>
                <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-1">
                  <span className="font-extrabold text-[#151235] block">Direct WhatsApp</span>
                  <a href="https://wa.me/918381835420" target="_blank" rel="noopener noreferrer" className="text-[#25D366] font-bold hover:underline">
                    Chat on WhatsApp
                  </a>
                </div>
                <div className="p-3.5 rounded-xl bg-[#F6F5FC] border border-[#EDEAFB] space-y-1 sm:col-span-2">
                  <span className="font-extrabold text-[#151235] block">Operational Locations</span>
                  <span className="text-[#5B5876]">Office: Prayagraj, Uttar Pradesh, India • Remote/Hybrid Hub: Pune, Maharashtra, India</span>
                </div>
              </div>
            </article>
