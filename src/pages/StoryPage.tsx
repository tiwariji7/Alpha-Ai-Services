...
const CORE_CONVICTIONS = [
  {
    ...
    icon: <Compass className="w-5 h-5 text-[#F4512C]" />,
  },
  {
    number: '02',
    ...
    icon: <Zap className="w-5 h-5 text-[#F4512C]" />,
  },
  {
    number: '03',
  ...
  return (
    ...
    >
      ...
      <section className="pt-8 sm:pt-14 pb-4 sm:pb-8 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4 sm:space-y-6">
          ...
          >
            ...
            <span className="text-[#F4512C]">Driven by Practical Purpose.</span>
          </motion.h1>
        ...
        <div className="space-y-6">
          {STORY_CHAPTERS.map((chapter, idx) => (
            <motion.div
              ...
              className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 border border-[#EDE9E4] hover:border-[#F4512C]/30 shadow-soft transition-all text-left space-y-4 relative overflow-hidden group"
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#EDE9E4]/80 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-xs font-mono font-bold text-[#F4512C] uppercase tracking-wider block">
                      {chapter.phase}
                    </span>
              ...
              <div className="text-xs sm:text-sm font-semibold text-[#111111] italic">
                "{chapter.subtitle}"
              </div>
        ...
        <div className="max-w-6xl mx-auto space-y-8 sm:space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2.5 sm:space-y-3">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#111111] tracking-tight leading-tight">
              Principles We <span className="text-[#F4512C]">Stand By.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 text-left">
            {CORE_CONVICTIONS.map((item) => (
              <div
                key={item.number}
                className="bg-[#FAF8F6] rounded-2xl sm:rounded-3xl p-6 sm:p-7 border border-[#EDE9E4] hover:border-[#F4512C]/30 shadow-2xs transition-all flex flex-col justify-between"
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs font-mono font-black text-[#8C867F]">
                      {item.number}
                    </span>
                  </div>
      ...
      <section className="px-4 sm:px-6 max-w-5xl mx-auto">
        <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-10 border border-[#EDE9E4] shadow-soft text-center space-y-5">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#F4512C]/10 border border-[#F4512C]/20 text-[#F4512C] text-[11px] sm:text-xs font-bold uppercase tracking-wider">
            <span>OUR PROMISE</span>
          </div>

          <h3 className="text-xl sm:text-2xl font-extrabold text-[#111111] max-w-xl mx-auto">
            Practical Software That Moves Your Business Forward
          </h3>

          <p className="text-xs sm:text-sm text-[#6B6660] max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="pt-2 flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs font-bold text-[#111111]">
            <span className="flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-[#F4512C]" />
        ...
        <div className="relative bg-[#111111] border border-[#2A2A2A] rounded-2xl sm:rounded-3xl p-6 sm:p-9 text-white text-center shadow-soft-lg overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-3 sm:space-y-4">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight leading-tight text-white">
              Want to Build <span className="text-[#F4512C]">Together?</span>
            </h2>
